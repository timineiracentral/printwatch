...
- [ ] **SERVER-01**: CUPS configurado como print server intermediário acessível via IPP na porta 631 pela faixa REDACTED_IP/16
- [ ] **SERVER-02**: `PageLogFormat` configurado explicitamente no `cupsd.conf` para garantir o formato esperado pelo parser
...
- [ ] **DEPLOY-01**: Deploy reproduzível via `docker compose up -d` em Ubuntu 22.04 LTS
